   ...
   new google.maps.places.Autocomplete(o).bindTo("bounds", i),
      ...
      document.getElementById("submit").addEventListener("click", function () {
         !(function (e, t) {
            e.route(
               {
                  origin: "R. Guilherme Farel, 1200 - Gleba Fazenda Palhano",
                  ...
                  ((s = (function (e) {
                     for (var t, i, o, n = $(e).find('[data-el="figure"]'), a = n.length, s = [], r = 0; r < a; r++)
                        1 === (t = n[r]).nodeType &&
                           ...
                           t.children[0].children[0].getAttribute("title")
                              ? (o.title = t.children[0].children[0].getAttribute("title"))
                              : (o.title = t.children[0].getAttribute("title")),
                           (o.el = t),
                           s.push(o));
                     return s;
                  })(t)),
...
function dataBgs() {
   $("[data-bg]").each(function () {
      ...
      $("[data-cor]").each(function () {
         $(this).css({ background: "rgba(" + $(this).attr("data-cor") + ",0.8)" }),
            "8" == DetectIE() && $(this).css({ background: "rgb(" + $(this).attr("data-cor") + ")" });
      });
}
function DetectIE() {
   var e = window.navigator.userAgent,
...
function accordion() {
   $(".accordion .thumb").click(function () {
      $(".accordion .thumb").not($(this)).removeClass("open"),
         $(".accordion .thumb").not($(this)).next().slideUp("open"),
...
function IsEmail(e) {
   return (
      -1 == e.search(/[^@\-\.\w]|^[_@\.\-]|[\._\-]{2}|[@\.]{2}|(@)[^@]*\1/) && -1 != e.search(/@[\w\-]+\./) && -1 != e.search(/\.[a-zA-Z]{2,3}$/)
   );
}
...
function SliderThumbImovel() {
   ...
   $(".SliderThumbImovel").slick({
      ...
      rows: t,
      responsive: [
         { breakpoint: 1025, settings: { slidesToShow: 3, slidesToScroll: 3, arrows: !1, dots: !1 } } /* TODO  */,
         { breakpoint: 860, settings: { slidesToShow: 2, arrows: !1, dots: !0 } },
...
function SliderVideo() {
   $(".SliderVideos").slick({
      ...
      dots: !1,
      arrows: !1,
      responsive: [{ breakpoint: 768, settings: { slidesToShow: 1, dots: !0 } }],
   });
}
...
function SliderQuemUtiliza() {
   $(".SliderQuemUtiliza").slick({
      infinite: !1,
      slidesToShow: 3,
      slidesToScroll: 1,
      dots: !1,
      arrows: !0,
      responsive: [{ breakpoint: 768, settings: { slidesToShow: 1, arrows: !1, dots: !0 } }],
   });
}
   ...
   new google.maps.places.Autocomplete(o).bindTo("bounds", i),
      ...
      document.getElementById("submit").addEventListener("click", function () {
         !(function (e, t) {
            e.route(
               {
                  origin: "Av. Ayrton Senna da Silva, 425 Gleba Palhano - Londrina - Paraná ",
                  destination: document.getElementById("destino").value,
                  travelMode: "DRIVING",
               },
               function (e, i) {
...
if (
   ...
   $(document).ready(function () {
      dataBgs(),
         ...
         $(".menu-galeria li").click(function (e) {
            ...
            $(".menu-galeria li a").removeClass("ativo"),
               $(this).find("a").addClass("ativo"),
               $(".slider").fadeOut(),
               $("." + t).fadeIn(),
               $(".slider > div").slick("setPosition");
         }),
   ...
   $(window).scroll(function () {
      isDesktop() &&
         ...
         $(window).scrollTop() >= menuDetalhe
            ? ($(".MenuDetalhe").addClass("fixo"), (scrolling = !0))
            : ($(".MenuDetalhe").removeClass("fixo"), (scrolling = !1)));
   });
}
...
var w = window.innerWidth || $(window).width(),
   ...
   arrsNovoDigito = [
      11, 12, 13, 14, 15, 16, 17, 18, 19, 21, 22, 24, 27, 28, 81, 82, 83, 84, 85, 86, 87, 88, 89, 91, 92, 93, 94, 95, 96, 97, 98, 99, 31, 32, 33,
      34, 35, 37, 38, 71, 73, 74, 75, 77, 79, 61, 62, 63, 64, 65, 66, 67, 68, 69,
   ],
   posicaoMenu = 0,
   scrollAtivo = !1;
if (
   ($(window).scroll(function () {
      isDesktop() &&
         ...
         $(window).scrollTop() >= posicaoMenu
            ? ($(".FiltroTopo").addClass("fixo"), (scrollAtivo = !0))
            : ($(".FiltroTopo").removeClass("fixo"), (scrollAtivo = !1)));
   }),
   $(document).ready(function () {
      $(".wc-header span").html("Chat  "),
         ...
         $(".fecha-chat").click(function (e) {
            e.preventDefault(),
               $(".chat-flutuante .chat").slideToggle(),
               $(".chat-flutuante").removeClass("maior"),
               $(".icone-chat").removeClass("ativo");
         }),
   ...
   $(document).ready(function () {
      ...
      if (
         ("" == e &&
            ...
            "" != document.referrer &&
            -1 == document.referrer.indexOf(document.location.origin) &&
            (e = document.referrer),
         "" != e)
      ) {
